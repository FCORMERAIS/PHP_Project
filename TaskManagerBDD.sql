...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 26 déc. 2022 à 22:09
...
CREATE TABLE IF NOT EXISTS `activity` (
  ...
  `lastTimeDo` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `invitationGroups` text,
  `idGroup` text NOT NULL,
  `lastTimeAddHabit` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`Id`)
